...
# ================================================================================================================
def HOGcorr_ppvcubes(cube1, cube2, z1min, z1max, z2min, z2max, ksz=1., mask1=0, mask2=0, s_cube1=0., s_cube2=0.):
      ...
      for k in range(z2min, z2max+1):  
         ...
         if np.array_equal(np.shape(cube1), np.shape(mask1)):
            if np.array_equal(np.shape(cube2), np.shape(mask2)):				
               circstats, corrframe, sframe1, sframe2 = HOGcorr_ima(frame1, frame2, ksz=ksz, mask1=mask1[i,:,:], mask2=mask2[k,:,:], s_ima1=s_cube1, s_ima2=s_cube2)
            else:
               circstats, corrframe, sframe1, sframe2 = HOGcorr_ima(frame1, frame2, ksz=ksz, mask1=mask1[i,:,:], s_ima1=s_cube1, s_ima2=s_cube2)
         else:
               circstats, corrframe, sframe1, sframe2 = HOGcorr_ima(frame1, frame2, ksz=ksz, s_ima1=s_cube1, s_ima2=s_cube2)
