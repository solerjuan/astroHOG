...
circstats, corrframe, smoothframe1, smoothframe2 = HOGcorr_imaANDcube(image1, cube2, ksz=ksz, mask1=mask1, mask2=mask2)
import pdb; pdb.set_trace()
# Print the correlation statistics obtained by astrohog
print('Circular statistics for gradient orientations ==================')
...
print('Circular statistics for gradient directions ==================')
print('Mean resultant vector (r)        ', circstats['RVLd'])
print('Rayleigh statistic (Z)           ', circstats['Zd'])
print('Projected Rayleigh statistic (V) ', circstats['Vd'])
